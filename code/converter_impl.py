...
class TextPreprocessor(object):
	...
	"""
	def __init__(self, option='-stemming 0 -stopword 0', readonly=False, tokenizer = "default" ):
		self._option  = option
		...
		#: Refer to :ref:`CustomizedPreprocessing`.
		    ...
		    self.tokenizer = self.default_tokenizer
                ...
                #set the chinese tokenizer
                if tokenizer == "chinese":
                    self.tokenizer = self.chinese_tokenizer
...
class Text2svmConverter(object):
	...
	def __init__(self, option="", readonly=False):
		...
		self.text_prep = TextPreprocessor(text_prep_opt, readonly, tokenizer = "chinese")
